...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="auto",
        help="auto: try login/bootstrap then fall back to 401 checks; required: fail if auth not available; none: skip auth attempts",
    )
    parser.add_argument("--auth-email", default=None, help="Auth email for protected endpoint checks")
    parser.add_argument("--auth-password", default=None, help="Auth password for protected endpoint checks")
